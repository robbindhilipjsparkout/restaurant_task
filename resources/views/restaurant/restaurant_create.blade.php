 ...
 <!-- <div class="login-form-bg h-100" style="margin-left:200px">  -->
     <div class="container h-100">
                ...
                <div style="margin:50px 0px 0px 0px"  class="card-header text-center bg-danger rounded-2 text-wrap">{{ __('Create restaurant') }}</div>
                    ...
                    <form method="POST" action="{{ route('restaurantstore')}}" style="margin-top:25px" id="myForm" class=" login-input " enctype="multipart/form-data">
                        ...
                        @csrf
                            ...
                            <input id="restaurant_name" type="text" class="form-control  @error('title')  @enderror is-invalid" name="restaurant_name" value="{{ old('restaurant_name') }}"  placeholder="restaurant_name">                           
        ...
        @enderror
                            ...
                            <input id="email" type="text" class="form-control  @error('title')  @enderror is-invalid"  name="email" value="{{ old('email') }}"  placeholder="email"> 
                            @error('email')
                                <div   id="error"  class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <label for="mobile_number">Mobile Number:</label> <span style="color: red;">*</span>
                                <input id="mobile_number" type="text" maxlength="10" class="form-control  @error('title')  @enderror is-invalid" name="mobile_number" value="{{ old('mobile_number') }}"  placeholder="mobile_number">
                                @error('mobile_number')
                                <div   id="error"  class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <label for="secondary_mobile_number">Secondary Mobile Number:</label>
                              <input id="secondary_mobile_number" type="tel"  maxlength="10"  class="form-control  @error('title')  @enderror is-invalid" name="secondary_mobile_number" value="{{ old('secondary_mobile_number') }}"  placeholder="secondary_mobile_number"> 
                            ...
                            <label for="image">Select a image:</label> <span style="color: red;">*</span>
                                <input id="restaurant_logo" type="file" class="form-control  @error('image')  @enderror is-invalid" name="restaurant_logo"  placeholder="restaurant_logo	">  
